...
<html>
 <head>
  ...
  <link href="css/moder.css" rel="stylesheet" type="text/css">
  <?php
...
echo ('
    ...
    <form action="moder.php" method="post" class="app one">
...
$html=$html.'<form action="reportad.php" method="post"><input type="hidden" name="id" value="'.$id.'"></input><div class="user"><img src="https://minotar.net/helm/'.$pnick.'/600.png "class="ava"> <span class="POD"> '.$pnick.' жалуется на </span><br><img src="https://minotar.net/helm/'.$nnick.'/600.png "class="ava"><span class="name">'.$nnick.'</span><br><span class="PODD">По причине: '.$reas.'</span><br><input type="submit" name="minus" class="usera" value="-"><br><br><input type="submit" name="plus" class="usera" value="+"></div></form>';
}}
echo ('</div>
...
echo('</div>');
 ...
 if($admin != 1):
    ...
    echo ('<button onclick="document.location='."'moder.php'".'" type="button" class="button buttfd list" style="margin-top:272px; background-color: rgba(146, 146, 146, 0.199); color:rgb(226, 226, 226);">Админ</button>
    <button onclick="document.location='."'main.php'".'" type="button" class="button buttfd" style="margin-top:-250px"><span style="color:aqua">False</span><span style="color:#FF4500"> Danger</span></button>
